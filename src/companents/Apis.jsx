...
const server = `https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=18&page=1&sparkline=false`
    ...
    return (
        <>
                <div className="row mx-auto">
                    ...
                    <h5 className='text-center all' ><Link to="/all" >All</Link></h5>
                </div>
